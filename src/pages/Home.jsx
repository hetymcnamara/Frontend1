...
export default function Home() {
  // let deployedURL = "https://snowbunny-backend.onrender.com/mountain";
  ...
  useEffect(() => {
    const fetchMountains = async () => {
      try {
        const response = await axios.get(
          "https://snowbunny-backend.onrender.com/mountain"
        );
    ...
    const fetchSavedMountains = async () => {
      try {
        const response = await axios.get(
          `https://snowbunny-backend.onrender.com/mountain/savedMountains/ids/${userID}`
        );
  ...
  const confirmDelete = async () => {
    try {
      await axios.delete(
        `https://snowbunny-backend.onrender.com/mountain/delete/${toBeDeleted}`
      );
            ...
            <article className="welcome-article">
              ...
              <body>
                <ul className="instructions">
                  ...
                  <li>
                    Create a list based on region or however else you plan your visit
                  </li>
                  ...
                  <ul className="sub-list">
                    ...
                    <li>
                      View open/closed/scheduled lift or chair
                      statistics
                    </li>
